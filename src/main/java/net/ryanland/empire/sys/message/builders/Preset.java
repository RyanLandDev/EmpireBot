...
public enum Preset implements PresetType {
    // seamless color = 0x2f3136

    DEFAULT(() -> null, () -> null, OffsetDateTime::now, () -> 0xffa500,
        () -> null, () -> null, () -> null, () -> null,
    ...
    Preset(Supplier<String> title, Supplier<String> description, Supplier<OffsetDateTime> timestamp, Supplier<Integer> color,
